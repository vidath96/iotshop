...
<div id="viewport">
  ...
  <dt style="width: 33.3%;">All Users</dt>
  <dd >
     ...
     <div class="container-fluid">
        ...
        <div class="main-panel-content">
            ...
            <div class="card" id="sales-summary">
              <div class="title">
                <h2>Users</h2>
                <p class="subtitle">Create users</p>
              </div>
              <div class="content">
                                                ...
                                                <?php foreach($results as $res) {?>
                                                  <tr>
                                                      <td>
                                                          ...
                                                          <a href="#" class="user-link"><?=$res->user_id?></a>
                                                          <span class="user-subhead"><?=$res->position?></span>
                                                      </td>
                                                      <td><?=$res->first_name?></td>
                                                      <td class="text-center">
                                                          <span class="label label-default"><?=$res->status?></span>
                                                      </td>
                                                      <td>
                                                          <a href="#"><?=$res->email?></a>
                                                      </td>
                                                      <td style="width: 20%;">
                                                          ...
                                                          <a href="<?php echo base_url('Admin/profile_one/').$res->user_id ?>" class="table-link">
                                                              <span class="fa-stack">
                                                                  <i class="fa fa-square fa-stack-2x"></i>
  ...
  <dt style="width: 33.3%;">Create User</dt>
  <dd>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
        <form action="<?=base_url('Admin/create_user_account'); ?>" method="post">
          <div class="col-sm-12">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 form-group">
                <label>NIC</label>
                <input type="text" name="nic" placeholder="Enter NIC Here.." class="form-control">
              </div> 
        ...
        <form action="<?=base_url('Admin/create_user_account'); ?>" method="post">
          <div class="col-sm-12">
           ...
           <!--  <input type="text" name="position" placeholder="Enter Position Here.." class="form-control"> -->
            ...
            <input type="text" class="form-control" name="ID" value="<?= $res->user_id ?>" disabled="disabled">

              </div>
              <div class="col-sm-4 form-group">
                <label>First Name</label>
                <input type="text" name="fname" class="form-control" value="<?= $res->first_name ?>">
              </div>
              <div class="col-sm-4 form-group">
                <label>Last Name</label>
                <input type="text" name="lname" value="<?= $res->last_name ?>" class="form-control">
              </div>
            </div>
                       
            <div class="form-group">
              <label>Address</label>
              <textarea name="address" rows="3" class="form-control"><?= $res->address ?></textarea>
            </div>  
            <div class="row">

              <div class="col-sm-4 form-group">
                <label>NIC</label>
                <input type="text" name="nic" value="<?= $res->nic ?>" class="form-control" >
              </div> 
            ...
            <label>Email Address</label>
              ...
              <div class="col-sm-4 form-group">
                <label>Contact No</label>
                <input type="text" name="contact" value="<?= $res->contact_no ?>" class="form-control">
              </div>    
            </div>
            <div class="row">
              <div class="col-sm-4 form-group">
              ...
              <div class="col-sm-4 form-group">
              <label>Position</label>
            <input type="text" name="position" class="form-control" value="<?= $res->position ?>" readonly>
...
<!-- 
          ...
          <div class="row">
              <div class="col-sm-6 form-group">
                <label>Gender</label><br>
                Male : <input type="radio" name="gender" value="male" class="" <?php if($res->gender=='male') {echo "checked";}?>>
                Female : <input type="radio" name="gender" value="female" class="" <?php if($res->gender=='female') {echo "checked";}?>>
              </div>  
